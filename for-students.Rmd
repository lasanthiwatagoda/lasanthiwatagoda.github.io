...
```{r, echo = FALSE}
df <- data.frame(Time = c("08:00-09:15", "09:30-10:45", "11:00-12:15", "12:15-01:00","01:00-03:00"), Monday = c("Research", "Research","Research", "Lunch Break", "Prep"), Tuesday = c("STT 2810 - 108", "STT 4880 - 101","STT 2810 - 109", "Lunch Break", "Office Hours"), Wednesday = c("Prep", "Prep","Research", "Lunch Break", "Research"), Thursday = c("STT 2810 - 108", "STT 4880 - 101","STT 2810 - 109", "Lunch Break", "Office Hours"))
