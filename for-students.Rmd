...
My office is in 340 Walker Hall. Office hours for the Spring are Tuesday and Thursday 1pm to 1:50pm and wednesday from 8am to 10am.Students may click on [book now](https://lasanthi.youcanbook.me/) to schedule an appointment.

```{r, echo = FALSE}
df <- data.frame(Time = c("08:00-09:15", "09:30-10:45", "11:00-12:15", "12:15-01:00","01:00-01:50"), Monday = c("Research", "Research","Research", "Prep", "Prep"), Tuesday = c("STT 2810 - 101", "STT 2810 - 103","STT 3851 - 101", "Lunch Break", "Office Hours"), Wednesday = c("Office Hours", "Office Hours","Prep", "Prep", "Prep"), Thursday = c("STT 2810 - 101", "STT 2810 - 103","STT 3851 - 101", "Lunch Break", "Office Hours"))
