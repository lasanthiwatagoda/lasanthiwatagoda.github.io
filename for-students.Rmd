...
My office is in 340 Walker Hall. Office hours for the spring are TBA. Students may click on [book now](https://lasanthi.youcanbook.me/) to schedule an appointment.

```{r, echo = FALSE}
df <- data.frame(Time = c("08:00-09:15", "09:30-10:45", "11:00-12:15"), Monday = c("Research", "Research", "Research"), Tuesday = c("STT 2810 - 102", "STT 3851 - 101", "STT 2810 - 104"), Wednesday = c("Office", "STT 3850", "STT 3850"), Thursday = c("STT 2810 - 102", "STT 3851 - 101", "STT 2810 - 104"), Friday = c("Research", "Research", "Research"))
