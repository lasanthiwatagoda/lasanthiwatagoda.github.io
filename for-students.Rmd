...
My office is in 340 Walker Hall. Office hours for the spring are 1.00 P.M. - 03:30 P.M. on Tuesday and Thursday. Students may click on [book now](https://lasanthi.youcanbook.me/) to schedule an appointment.

```{r, echo = FALSE}
df <- data.frame(Time = c("08:00-09:15", "09:30-10:45", "11:00-12:15", "12:15-03:30"), Monday = c("Research", "Research", "Research", "Research"), Tuesday = c("STT 2810 - 102", "STT 3851 - 101", "STT 2810 - 104", "Office Hours"), Wednesday = c(" ", "Prep", "Prep", "Prep"), Thursday = c("STT 2810 - 102", "STT 3851 - 101", "STT 2810 - 104", "Office Hours"), Friday = c("Research", "Research", "Research", "Research"))
